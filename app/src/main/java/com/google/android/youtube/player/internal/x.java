...
public final class x {
    public static Map<String, String> a(Locale var0) {
        HashMap var1;
        HashMap var2;
        ...
        a(var1, var0.getLanguage());
        String var4 = String.valueOf(var0.getLanguage());
        String var3 = String.valueOf(var0.getCountry());
        a(var1, (new StringBuilder(1 + String.valueOf(var4).length() + String.valueOf(var3).length())).append(var4).append("_").append(var3).toString());
        return var1;
    }

    private static void a(Map<String, String> var0, String var1) {
        if ("af".equals(var1)) {
